...
const Home: React.FC = () => {
  ...
  <p>Hi! I'm so glad you're here! I am Vedansh and I am currently working on making autonomous agents. I am primarily focussing on two things and these will stay true for atleast several years in the future: firstly, creating something, and secondly, collecting feedback from users who use that thing. I also believe it's important to carry out these tasks quickly and with assertiveness, even when the best choices are not clear. I am a <a href="https://pmarca.substack.com/p/the-techno-optimist-manifesto" target="_blank">techno-optimist</a>.</p>
  <p>Lets talk!</p>
