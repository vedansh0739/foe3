...
const Home: React.FC = () => {
  ...
  <p>Hi! I'm so glad you're here! I am Vedansh and I am currently working on making autonomous agents. I am primarily focussing on two things and these will stay true for atleast several years in the future: firstly, creating something, and secondly, collecting feedback from users who use that thing. I also believe it's important to carry out these tasks quickly and with assertiveness, even when the best choices are not clear. Inspired by John Carmack, I try maximize the time I spend operating on something like a <a href="https://www.youtube.com/watch?v=I845O57ZSy4&t=18762s"  target='_blank'>gradient descent</a>.</p>
  <p>Lets talk!</p>
