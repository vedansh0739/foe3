...
const Home: React.FC = () => {
  ...
  <p>Hi! I'm so glad you're here! I am Vedansh and I am currently working on making autonomous agents. I am primarily focussing on two things and these will stay true for several years in the future: firstly, creating something, and secondly, collecting feedback from users who use that something. I also believe it's important to carry out these tasks quickly and with assertiveness, even when the best choices are not clear, in order to contribute more effectively to the bigger goal of expanding human consciousness while minimising non productive suffering.</p>
  <p>Lets talk!</p>
